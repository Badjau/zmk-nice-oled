...
static void draw_usb_connected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 0, 5, &usb, &img_dsc);
}
...
static void draw_ble_unbonded(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 0, 5, &bt_unbonded, &img_dsc);
}
#endif
...
static void draw_ble_disconnected(lv_obj_t *canvas) {
    ...
    lv_canvas_draw_img(canvas, 0, 5, &bt_no_signal, &img_dsc);
}
